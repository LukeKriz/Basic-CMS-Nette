...
/** source: C:\wamp64\www\CMS\app\AdminModule\Presenters/templates/Cms/editor.latte */
final class Template3606893db7 extends Latte\Runtime\Template
{
	public const Source = 'C:\\wamp64\\www\\CMS\\app\\AdminModule\\Presenters/templates/Cms/editor.latte';
        ...
        <div class="col-xl-12 col-lg-8">
            <div class="shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Editor CMS stánky</h6>
                </div>
                <div class="card-body">
';
